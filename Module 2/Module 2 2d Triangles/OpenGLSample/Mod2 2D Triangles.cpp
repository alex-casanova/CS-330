...
void UCreateMesh(GLMesh& mesh)
{
    ...
    GLfloat verts[] =
    {
        ...
        // index 0
        -1.0f, 0.0f, 0.0f,      // far-left of the screen
        ...
        // index 2
        -0.5f, 0.0f, 0.0f,      // intersection of the 2 triangles, halfway to the left of the screen
        0.0f, 1.0f, 0.0f, 1.0f, // green

        // index 3
        0.0f, 0.0f, 0.0f,       // center of the screen  - top right corner of triangle 2
        1.0f, 0.0f, 0.0f, 1.0f, // red
